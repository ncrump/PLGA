...
EAfile =  '1finalnvt_H2O_reimaged.gro'
outfile = '1startnvt_LGA+H2O_0.5Agap.gro'
...
# read in .gro files
delimiter = [8,7,5,8,8,8]
res1,atm1,num1,x1,y1,z1 = np.genfromtxt(LGAfile,skiprows=2,delimiter=delimiter,skip_footer=1,dtype=str,unpack=True)
res2,atm2,num2,x2,y2,z2 = np.genfromtxt(EAfile,skiprows=2,delimiter=delimiter,skip_footer=1,dtype=str,unpack=True)
...
for i in range(N1):
    f.write('%8s%5s%5s%8.3f%8.3f%8.3f\n' %
