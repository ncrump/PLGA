"""
Generates FCC lattice of PLGA chains from input pdb
Places center of chain at face centered orthorhombic lattice sites
"""
...
# set input variables
# ---------------------------------------------------------------------------
filename = '2plga_opt_unitedatom'
nD = 0.003  # number density (chains/cu angstrom)
pD = 0.50   # percentage of number density to use
dx = 9      # x distance between chains (angstrom)
dy = 12     # y distance between chains (angstrom)
dz = 7      # z distance between chains (angstrom)
...
fname = '2plga_'+str(N)+'Lattice.pdb'
f = open(fname,'w')
f.write('HEADER    PYTHON GENERATED PDB LATTICE DDMMMYYYY\n')
f.write('TITLE     2PLGA\n')
f.write('COMPND    POLY LACTIC GLYCOLIC ACID\n')
