"""
Analyzes LGA+EA trajectory to count number of LGA that cross interface
"""
...
nres0,natm0,num0,xatm0,yatm0,zatm0,vxatm0,vyatm0,vzatm0 = np.genfromtxt(fgro,dtype=str,delimiter=delimiter,unpack=True)

# format arrays to keep only LGA
print 'analyzing trajectory ...'
Ntot = len(nres0)
indx = np.arange(2,Ntot,lgaMOL*lgaATM+eeeMOL*eeeATM+3)
